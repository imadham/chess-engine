public class PrincipalVariation {
    ...
    public static int pvSearch(int alpha,int beta,long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ,boolean WhiteToMove,int depth) {//using fail soft with negamax
        ...
        if (firstLegalMove == -1)
        {
            return WhiteToMove ? Start.MATE_SCORE : -Start.MATE_SCORE;
        }
        ...
        Start.moveCounter++;
        if (Math.abs(bestScore) == Start.MATE_SCORE)
        {
            return bestScore;
        }
        if (bestScore > alpha)
        ...
        for (int i=firstLegalMove;i<moves.length();i+=4) {
            ...
            score = -pvSearch(-beta,-alpha,WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt,EPt,CWKt,CWQt,CBKt,CBQt,!WhiteToMove,depth+1);
      /*      score = -zWSearch(-alpha,WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt,EPt,CWKt,CWQt,CBKt,CBQt,!WhiteToMove,depth+1);
            ...
            if ((score != Start.NULL_INT) && (score > bestScore))
            {
                if (score >= beta)
                {
                    return score;
    ...
    public static int white(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ){
    	int rat =Integer.MAX_VALUE,temp;
       ...
       //		Start.ratWhite=true;
               ...
               if (((WKt&Moves.unsafeForWhite(WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt))==0)){
            	   counter++;
            	  temp=black1(WPt, WNt, WBt, WRt, WQt, WKt, BPt, BNt, BBt, BRt, BQt, BKt, EPt, CWKt, CWQt, CBKt, CBQt);
            	//   temp=Rating.evaluate(WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt,EPt,CWKt,CWQt,CBKt,CBQt,false);
            	   if(temp<rat)rat=temp;
               }
    	...
    	if(counter==0) return 100000;
    	return rat;
    }
    public static int black(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ){
    	int rat =Integer.MAX_VALUE,temp;
    	long WPt=0L,WNt=0L,WBt=0L,WRt=0L,WQt=0L,WKt=0L,BPt=0L,BNt=0L,BBt=0L,BRt=0L,BQt=0L,BKt=0L,EPt=0L;
    	String moves="";
    	int counter=0;
       ...
       //		Start.ratWhite=true;
               ...
               if (((BKt&Moves.unsafeForBlack(WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt))==0)){
            	 counter++;
            	   ...
            	   temp=white1(WPt, WNt, WBt, WRt, WQt, WKt, BPt, BNt, BBt, BRt, BQt, BKt, EPt, CWKt, CWQt, CBKt, CBQt);
            	   
            	  // temp=Rating.evaluate(WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt,EPt,CWKt,CWQt,CBKt,CBQt,true);
            	  
            	   if(temp<rat)rat=temp;
            	 //  if(Start.print){System.out.println(rat+" "+moves.substring(i,i+4));Start.print=false;}
               }
    ...
    public static int white1(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ){
    	int rat =Integer.MIN_VALUE,temp;
    	long WPt=0L,WNt=0L,WBt=0L,WRt=0L,WQt=0L,WKt=0L,BPt=0L,BNt=0L,BBt=0L,BRt=0L,BQt=0L,BKt=0L,EPt=0L;
    	String moves="";
    	int counter=0;
    	moves=Moves.possibleMovesW(WP,WN,WB,WR,WQ,WK,BP,BN,BB,BR,BQ,BK,EP,CWK,CWQ,CBK,CBQ);
       ...
       //		Start.ratWhite=true;
               ...
               if (((WKt&Moves.unsafeForWhite(WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt))==0)){
            	  ...
            	  // temp=black2(WPt, WNt, WBt, WRt, WQt, WKt, BPt, BNt, BBt, BRt, BQt, BKt, EPt, CWKt, CWQt, CBKt, CBQt);
    ...
    public static int black1(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ){
    	int rat =Integer.MIN_VALUE,temp;
    	long WPt=0L,WNt=0L,WBt=0L,WRt=0L,WQt=0L,WKt=0L,BPt=0L,BNt=0L,BBt=0L,BRt=0L,BQt=0L,BKt=0L,EPt=0L;
    	String moves="";
    	int counter=0;
       ...
       //		Start.ratWhite=true;
               ...
               if (((BKt&Moves.unsafeForBlack(WPt,WNt,WBt,WRt,WQt,WKt,BPt,BNt,BBt,BRt,BQt,BKt))==0)){
            	 ...
            	 //  temp=white2(WPt, WNt, WBt, WRt, WQt, WKt, BPt, BNt, BBt, BRt, BQt, BKt, EPt, CWKt, CWQt, CBKt, CBQt);
    ...
    public static int white2(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ){
    	int rat =Integer.MAX_VALUE,temp;
    	long WPt=0L,WNt=0L,WBt=0L,WRt=0L,WQt=0L,WKt=0L,BPt=0L,BNt=0L,BBt=0L,BRt=0L,BQt=0L,BKt=0L,EPt=0L;
    	String moves="";
    	moves=Moves.possibleMovesW(WP,WN,WB,WR,WQ,WK,BP,BN,BB,BR,BQ,BK,EP,CWK,CWQ,CBK,CBQ);
    ...
    public static int black2(long WP,long WN,long WB,long WR,long WQ,long WK,long BP,long BN,long BB,long BR,long BQ,long BK,long EP,boolean CWK,boolean CWQ,boolean CBK,boolean CBQ){
    	int rat =Integer.MAX_VALUE,temp;
    	long WPt=0L,WNt=0L,WBt=0L,WRt=0L,WQt=0L,WKt=0L,BPt=0L,BNt=0L,BBt=0L,BRt=0L,BQt=0L,BKt=0L,EPt=0L;
    	String moves="";
    	moves=Moves.possibleMovesB(WP,WN,WB,WR,WQ,WK,BP,BN,BB,BR,BQ,BK,EP,CWK,CWQ,CBK,CBQ);
